---
layout: post
title: Programming on a (School) Chromebook
---

I do not own a computer. This means that to do programming, I can either wait until I get home or find a method to program on the school computer. I am usually motivated to program during the mornings, so I chose the latter option. I, as well as many others, have a Chromebook as the school computer. Either due to strict parenting or a lack of funds, many people can only access online content through this Chromebook. Back to the point, the methods to program on a Chromebook differ based on whether they are managed by the school or not.

Normal Chromebook:
For normal chromebooks, it is much easier to setup a development environment. ChromeOS is a Linux distro, meaning that you can simply go into the settings and enable the shell, allowing you to run executables and do most of what you can on any other GNU/Linux distro. Obviously, you could simply install another operating system, which would rid you of having the problem in the first place.
...
These should allow for basic developement that does not involve GUI applications. Although these methods are difficult to use and feature-poor, something is better than nothing.